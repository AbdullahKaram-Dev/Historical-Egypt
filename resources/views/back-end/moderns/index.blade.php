                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody class="rowsmodern">
                                @foreach($rows as $row)
                                    @php
                                        $post_id = $row->id;
                                            $likes = \App\Models\ModernLike::where('post_id' ,$post_id  )
                                            ->where('like', 1)->count();
                                        $dislikes =\App\Models\ModernLike::where('post_id' ,$post_id  )
                                            ->where('like' , 0)->count();
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('singlepost.Moderns', ['id' =>$row->id])}}">
                                                <button type="submit" class="btn btn-primary">Show</button>
                                            </a></td>

                                        <td> <a href="{{route('modern.comments', ['id' =>$row->id])}}">
