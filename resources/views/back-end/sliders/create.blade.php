...
@section('content')
        <div class="box-body">
            ...
            <form  action="{{route(''.$routeName.'.store')}}" method="post" enctype="multipart/form-data">
                ...
                <!-- /. tools -->
                <div class="form-group">
                    <textarea id="editor1"  class="form-control"  name="content" rows="10" cols="250"  placeholder="Enter Your Post" >{{old('post')}}</textarea>
                </div>
                <div class="form-group">
                    <label>Group</label>
                ...
                <button type="submit" name="save" class="btn btn-warning">Share Slider</button>
