...
@section('search')
    ...
    <form class="sidebar-form">
        ...
        <div class="input-group">
            <input type="text" name="q" id="search-pharaonic" class="form-control" placeholder="Search by Title...">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div style="text-align: right">
                                <a href="{{route(''.$routeName.'.create')}}"><button type="button" class="btn btn-block btn-warning btn-lg">Add Post</button></a>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody class="rowspharaonic">
                                @foreach($rows as $row)
                                    @php
                                        $post_id = $row->id;
                                            $likes = \App\Models\PharaonicLike::where('post_id' ,$post_id  )
                                            ->where('like', 1)->count();
                                        $dislikes =\App\Models\PharaonicLike::where('post_id' ,$post_id  )
                                            ->where('like' , 0)->count();
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('singlepost.Pharaonics', ['id' =>$row->id])}}">
                                                <button type="submit" class="btn btn-primary">Show</button>
                                            </a></td>

                                        <td> <a href="{{route('pharaonic.comments', ['id' =>$row->id])}}"> <button type="submit"  class="btn btn-warning">Comments</button></a></td>
