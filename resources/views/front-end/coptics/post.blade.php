        ...
        <div class="upper-all"><!--strat upper-all-->
            ...
            <div class="row">
                <div class="col-md-12 bar-like ">
                    ...
                    <a class="likee  btn {{$stylelike}} tip"
                    ...
                    <a class="dislike  btn {{$styledislike}} tip "
                    ...
                    @php
                        $comment = App\Models\CopticComment::where('post_id' , $rows->id)->get();
                    @endphp
                                        ...
                                        @foreach($AllComments->reverse() as $comment)
                                            ...
                                            <li class="media" id="comment{{$comment->id}}">
                                                ...
                                                <div class="media-body">
                                                 ...
                                                 @endforeach
                                                        @php
                                                            $replies = App\Models\Coptic_reply::where('comment_id',$comment->id)->get();
                                                        @endphp
                                                            ...
                                                            @if(auth()->user()->id == $comment->user_id)
                                                                ...
                                                                <div class=" btn-circle text-uppercase"
                                                                    ...
                                                                    <form >
                                                                        ...
                                                                        <button type="submit"  class="btn btn-danger btn-delete">DELETE
                                                                        </button>
                                                                    </form>
                                                        ...
                                                        <ul class="media-list">
                                                            <form >
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <button comment_id="{{ $comment->id }}" class="btn btn-warning btn-circle text-uppercase submitReply"
                                ...
                                <div class="tab-pane" id="add-comment-disabled">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        <form >
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                   <button class="btn btn-warning btn-circle text-uppercase submitComment"
                                                            type="submit" >Summit comment
                                                    </button>
                                                </div>
                                            </div>
