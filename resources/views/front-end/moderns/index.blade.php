...
<div class="pharaonic">
    <div class="container all">
            ...
            <div class="text-center">
                <form class="form-inline ml-auto">
                    <div class="md-form my-0">
                        <input class="form-control mr-sm-2" id="search-modern" type="text" placeholder="Search by Title..." aria-label="Search">
                    </div>
                </form>
            </div>
        </div>
        ...
        <section class="grid text-center rowsmodern" id="grid" style="color: #ff5959">
                @foreach($rows as $row)
    ...
    <div class="Most-popular">
        <div class="container">
            <div class="row">
                ...
                @foreach($MostPopularModern as $PopularModern)
