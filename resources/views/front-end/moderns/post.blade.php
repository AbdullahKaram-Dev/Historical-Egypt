        ...
        <div class="upper-all"><!--strat upper-all-->
            ...
            <div class="row">
                <div class="col-md-12 bar-like ">
                    ...
                    <a class="likeeee  btn {{$stylelike}} tip"
                    ...
                    <a class="dislikeee  btn {{$styledislike}} tip"
                    ...
                    @php
                        $comment = App\Models\ModernComment::where('post_id' , $rows->id);
                    @endphp
                    ...
                    <a href="#" class="btn btn-default disabled"><i class="fa fa-eye"></i>{{' '. $rows->viewers .' Views'}}</a>
                            ...
                            <div class="tab-content">
                                            ...
                                            <li class="media" id="comment{{$comment->id}}">
                                                ...
                                                <div class="media-body">
                                                    <div class="well well-lg">
                                                        ...
                                                        @endforeach
                                                        @php
                                                            $replies = App\Models\Modern_reply::where('comment_id',$comment->id)->get();
                                                        @endphp
                                                        ...
                                                        @if(auth()->user()->id == $comment->user_id)
                                                            ...
                                                            <div class=" btn-circle text-uppercase" style="float: right">
                                                                ...
                                                                <form >
                                                                  ...
                                                                  <button type="submit"  class="btn btn-danger deleteModern">DELETE
                                                                  </button>
                                                              </form>
                                                                        ...
                                                                        @if(auth()->user()->id == $reply->user_id)
                                                                            ...
                                                                            <div class=" btn-circle text-uppercase" style="float: right">
                                                                                ...
                                                                                <form >
                                                                                    ...
                                                                                    class="btn btn-danger deleteModernReply">
                                                                                        DELETE
                                                                                    </button>
                                                                                </form>
                                                        ...
                                                        <ul class="media-list">
                                                            <form >
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <button comment_id="{{ $comment->id }}" class="btn btn-warning btn-circle text-uppercase ReplyModern"
                                ...
                                <div class="tab-pane" id="add-comment-disabled">
                                    ...
                                    <form >
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                               <button class="btn btn-warning btn-circle text-uppercase CommentModern"type="submit" >
