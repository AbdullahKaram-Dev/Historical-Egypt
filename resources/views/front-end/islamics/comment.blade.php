...
<div class="tab-content">
                            ...
                            @if(auth()->user()->id == $comment->user_id)
                                ...
                                <div class=" btn-circle text-uppercase" style="float: right">
                                    ...
                                    <form >
                                      ...
                                      <button type="submit"  class="btn btn-danger deleteIslamic">DELETE
                                      </button>
                                  </form>
                            ...
                            <ul class="media-list">
                                <form >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button comment_id="{{ $comment->id }}" class="btn btn-warning btn-circle text-uppercase ReplyIslamic"
    ...
    <div class="tab-pane" id="add-comment-disabled">
        ...
        <form >
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                   <button class="btn btn-warning btn-circle text-uppercase CommentIsalmic"type="submit" >
